...
!(function (t, n) {
  ...
  return (function (t) {
    ...
    function (t, n, i) {
      ...
      function p(t) {
        var n,
          i = (n = t) ? ("string" == typeof n ? n.split(".") : [n]) : [];
        return function (t) {
      ...
      ((n = t.exports = {}).hasOwnProp = u),
        ...
        (n.groupBy = function (t, n, i) {
          for (var r = {}, e = c(n) ? n : p(n), s = 0; s < t.length; s++) {
            var o = t[s],
              u = e(o, s);
            if (void 0 === u && !0 === i)
              throw new TypeError(
        ...
        (n.without = function (t) {
          var n = [];
          if (!t) return n;
          for (var i = t.length, r = d(arguments).slice(1), e = -1; ++e < i; )
            -1 === m(r, t[e]) && n.push(t[e]);
          return n;
        }),
        ...
        (n.inOperator = function (t, n) {
          if (a(n) || l(n)) return -1 !== n.indexOf(t);
      ...
      (f.prototype = Object.create(String.prototype, {
        ...
        (t.exports = {
          ...
          makeMacro: function (t, n, i) {
            return function () {
              for (var r = arguments.length, e = Array(r), s = 0; s < r; s++)
                e[s] = arguments[s];
              var o,
                f = h(e),
                c = (function (t) {
              ...
              if (f > t.length)
                (o = e.slice(0, t.length)),
                  e.slice(o.length, f).forEach(function (t, i) {
                    i < n.length && (c[n[i]] = t);
                  }),
                  o.push(c);
              else if (f < t.length) {
                o = e.slice(0, f);
                for (var a = f; a < t.length; a++) {
                  var l = t[a];
                  o.push(c[l]), delete c[l];
                }
                o.push(c);
              } else o = e;
                ...
                for (var f = 0; f < t.length; f++) {
                  ...
                  switch (n) {
                    ...
                    case 3:
                      ...
                      break;
                    default:
                      c.push(f, s, h), i.apply(this, c);
                  }
                }
            else {
              var a = r.keys(t || {});
              if (((s = a.length), (o = Array(s)), 0 === s)) e(null, "");
              else
    ...
    function (t, n, i) {
      ...
      function u(t, n, i) {
        t instanceof n && i.push(t), t instanceof h && t.findAll(n, i);
      }
      var h = (function (t) {
          function n() {
            return t.apply(this, arguments) || this;
        ...
        p = c.extend("Group"),
        d = c.extend("Array"),
        m = h.extend("Pair", { fields: ["key", "value"] }),
        w = c.extend("Dict"),
        b = h.extend("LookupVal", { fields: ["target", "val"] }),
        y = h.extend("If", { fields: ["cond", "body", "else_"] }),
        g = y.extend("IfAsync"),
        k = h.extend("InlineIf", { fields: ["cond", "body", "else_"] }),
        E = h.extend("For", { fields: ["arr", "name", "body", "else_"] }),
        O = E.extend("AsyncEach"),
        x = E.extend("AsyncAll"),
        j = h.extend("Macro", { fields: ["name", "args", "body"] }),
        T = j.extend("Caller"),
        A = h.extend("Import", {
        ...
        N = (function (t) {
          ...
          return (
            ...
            (n.prototype.init = function (n, i, r, e, s) {
              t.prototype.init.call(this, n, i, r, e || new c(), s);
            }),
            e(n, [
              {
                key: "typename",
        ...
        S = h.extend("FunCall", { fields: ["name", "args"] }),
        _ = S.extend("Filter"),
        L = _.extend("FilterAsync", { fields: ["name", "args", "symbol"] }),
        F = w.extend("KeywordArgs"),
        I = h.extend("Block", { fields: ["name", "body"] }),
        C = h.extend("Super", { fields: ["blockName", "symbol"] }),
        R = h.extend("TemplateRef", { fields: ["template"] }).extend("Extends"),
        K = h.extend("Include", { fields: ["template", "ignoreMissing"] }),
        M = h.extend("Set", { fields: ["targets", "value"] }),
        P = h.extend("Switch", { fields: ["expr", "cases", "default"] }),
        B = h.extend("Case", { fields: ["cond", "body"] }),
        V = c.extend("Output"),
        D = h.extend("Capture", { fields: ["body"] }),
        U = l.extend("TemplateData"),
        $ = h.extend("UnaryOp", { fields: ["target"] }),
        G = h.extend("BinOp", { fields: ["left", "right"] }),
        W = G.extend("In"),
        H = G.extend("Is"),
        J = G.extend("Or"),
        z = G.extend("And"),
        ...
        Z = G.extend("Mul"),
        tt = G.extend("Div"),
        nt = G.extend("FloorDiv"),
        it = G.extend("Mod"),
        rt = G.extend("Pow"),
        et = $.extend("Neg"),
        st = $.extend("Pos"),
        ot = h.extend("Compare", { fields: ["expr", "ops"] }),
        ut = h.extend("CompareOperand", { fields: ["expr", "type"] }),
        ht = h.extend("CallExtension", {
        ...
        ft = ht.extend("CallExtensionAsync");
      function ct(t, n, i) {
        var r = t.split("\n");
      ...
      t.exports = {
        ...
        printNodes: function t(n, i) {
          if (((i = i || 0), ct(n.typename + ": ", i), n instanceof c))
            ct("\n"),
            ...
            n.iterFields(function (t, n) {
              t instanceof h ? r.push([n, t]) : ((e = e || {})[n] = t);
            }),
              e ? ct(JSON.stringify(e, null, 2) + "\n", null, !0) : ct("\n"),
    ...
    function (t, n, i) {
      ...
      var e = i(8),
        ...
        c = (function (t) {
          ...
          return (
            ...
            (s.T = function (t) {
              var n = this.f;
              (this.f = ""), t.call(this), this.x(), (this.f = n);
            }),
            (s.A = function (t) {
              var n = this.v();
              return (
            ...
            (s.compileCallExtension = function (t, n, i) {
              var r = this,
                e = t.args,
                s = t.contentArgs,
            ...
            (s.compileCallExtensionAsync = function (t, n) {
              this.compileCallExtension(t, n, !0);
            }),
            (s.compileNodeList = function (t, n) {
              this.S(t, n);
            }),
            (s.compileLiteral = function (t) {
            ...
            (s.compileGroup = function (t, n) {
              this._(t, n, "(", ")");
            }),
            (s.compileArray = function (t, n) {
              this._(t, n, "[", "]");
            }),
            (s.compileDict = function (t, n) {
              this._(t, n, "{", "}");
            }),
            (s.compilePair = function (t, n) {
              var i = t.key,
                r = t.value;
              i instanceof o.Symbol
                ? (i = new o.Literal(i.lineno, i.colno, i.value))
                : (i instanceof o.Literal && "string" == typeof i.value) ||
                  this.fail(
            ...
            (s.compileInlineIf = function (t, n) {
              this.w("("),
            ...
            (s.compileOr = function (t, n) {
              return this.F(t, n, " || ");
            }),
            (s.compileAnd = function (t, n) {
              return this.F(t, n, " && ");
            }),
            (s.compileAdd = function (t, n) {
              return this.F(t, n, " + ");
            }),
            (s.compileConcat = function (t, n) {
              return this.F(t, n, ' + "" + ');
            }),
            (s.compileSub = function (t, n) {
              return this.F(t, n, " - ");
            }),
            (s.compileMul = function (t, n) {
              return this.F(t, n, " * ");
            }),
            (s.compileDiv = function (t, n) {
              return this.F(t, n, " / ");
            }),
            (s.compileMod = function (t, n) {
              return this.F(t, n, " % ");
            }),
            (s.compileNot = function (t, n) {
              this.w("!"), this.compile(t.target, n);
            }),
            (s.compileFloorDiv = function (t, n) {
              this.w("Math.floor("),
                this.compile(t.left, n),
                this.w(" / "),
                this.compile(t.right, n),
            ...
            (s.compileNeg = function (t, n) {
              this.w("-"), this.compile(t.target, n);
            }),
            (s.compilePos = function (t, n) {
              this.w("+"), this.compile(t.target, n);
            }),
            (s.compileCompare = function (t, n) {
              var i = this;
              this.compile(t.expr, n),
                t.ops.forEach(function (t) {
                  i.w(" " + f[t.type] + " "), i.compile(t.expr, n);
                });
            }),
            (s.compileLookupVal = function (t, n) {
            ...
            (s.compileFilterAsync = function (t, n) {
              var i = t.name,
                r = t.symbol.value;
              this.assertType(i, o.Symbol),
                n.set(r, r),
            ...
            (s.compileKeywordArgs = function (t, n) {
              this.w("runtime.makeKeywordArgs("),
                this.compileDict(t, n),
                this.w(")");
            }),
            (s.compileSet = function (t, n) {
              var i = this,
                r = [];
            ...
            (s.compileIfAsync = function (t, n) {
              this.w("(function(cb) {"),
                this.compileIf(t, n, !0),
                this.w("})(" + this.A()),
                this.j();
            }),
            (s.C = function (t, n, i, r) {
              var e = this;
              [
                { name: "index", val: i + " + 1" },
                { name: "index0", val: i },
            ...
            (s.compileFor = function (t, n) {
              ...
              if (
                ...
                this.y(";"),
                this.w("if(" + s + ") {"),
                this.y(s + " = runtime.fromIterator(" + s + ");"),
                t.name instanceof o.Array)
              ) {
                this.y("var " + r + ";"),
                  this.y("if(runtime.isArray(" + s + ")) {"),
                  this.y("var " + e + " = " + s + ".length;"),
                  this.y(
                    "for(" +
                      r +
                      "=0; " +
                  ...
                  t.name.children.forEach(function (e, o) {
                    var u = i.v();
                    i.y("var " + u + " = " + s + "[" + r + "][" + o + "];"),
                      i.y(
                        'frame.set("' +
                      ...
                      n.set(t.name.children[o].value, u);
                  }),
                  this.C(t, s, r, e),
                  this.T(function () {
                    i.compile(t.body, n);
                ...
                n.set(h.value, c),
                  n.set(f.value, a),
                  this.y(r + " = -1;"),
                  this.y("var " + e + " = runtime.keys(" + s + ").length;"),
                  this.y("for(var " + c + " in " + s + ") {"),
                  this.y(r + "++;"),
                  this.y("var " + a + " = " + s + "[" + c + "];"),
                  this.y('frame.set("' + h.value + '", ' + c + ");"),
                  this.y('frame.set("' + f.value + '", ' + a + ");"),
                  this.C(t, s, r, e),
                  this.T(function () {
                    i.compile(t.body, n);
                  }),
            ...
            (s.compileAsyncEach = function (t, n) {
              this.R(t, n);
            }),
            (s.compileAsyncAll = function (t, n) {
              this.R(t, n, !0);
            }),
            (s.K = function (t, n) {
              var i = this,
                ...
                s = "macro_" + this.v(),
                u = void 0 !== n;
              t.args.children.forEach(function (n, s) {
                s === t.args.children.length - 1 && n instanceof o.Dict
                  ? (e = n)
                  : (i.assertType(n, o.Symbol), r.push(n));
              });
              var f,
                c = [].concat(
                  r.map(function (t) {
              ...
              (f = u ? n.push(!0) : new h()),
                this.g(
                  ...
                  "frame = " +
                    (u ? "frame.push(true);" : "new runtime.Frame();"),
                  "kwargs = kwargs || {};",
              ...
              return (
                ...
                this.y("frame = " + (u ? "frame.pop();" : "callerFrame;")),
            ...
            (s.compileCaller = function (t, n) {
              this.w("(function (){");
              var i = this.K(t, n);
              this.w("return " + i + ";})()");
            }),
            (s.M = function (t, n, i, r) {
              var e = this.v(),
                s = this.N(),
                o = this.A(e),
                u = i ? "true" : "false",
            ...
            (s.compileFromImport = function (t, n) {
              var i = this,
                r = this.M(t, n, !1, !1);
              this.j(),
                this.y(
                ...
                t.names.children.forEach(function (t) {
                  ...
                  t instanceof o.Pair
                    ...
                    n.parent
                      ? i.y('frame.set("' + s + '", ' + u + ");")
                      : i.y('context.setVariable("' + s + '", ' + u + ");");
                });
            }),
            (s.compileBlock = function (t) {
              var n = this.v();
              this.inBlock ||
                this.w(
                ...
                this.inBlock || this.w(")"),
                this.y("(env, context, frame, runtime, " + this.A(n)),
                this.y(this.buffer + " += " + n + ";"),
                this.j();
            }),
            (s.compileSuper = function (t, n) {
            ...
            (s.compileInclude = function (t, n) {
              ...
              this.y("tasks.push("),
                ...
                this.y(
                  "template.render(context.getVariables(), frame, " + this.A(r)
                ),
            ...
            (s.compileTemplateData = function (t, n) {
              this.compileLiteral(t, n);
            }),
            (s.compileCapture = function (t, n) {
              var i = this,
                r = this.buffer;
              (this.buffer = "output"),
                this.y("(function() {"),
            ...
            (s.compileOutput = function (t, n) {
              var i = this;
              t.children.forEach(function (r) {
                r instanceof o.TemplateData
                  ? r.value &&
      ...
      t.exports = {
        compile: function (t, n, i, r, o) {
          void 0 === o && (o = {});
          var u = new c(r, o.throwOnUndefined),
            h = (i || [])
              .map(function (t) {
                return t.preprocess;
              })
          ...
          return u.compile(s.transform(e.parse(h, i, o), n, r)), u.getCode();
        },
        Compiler: c,
      };
    },
    ...
    function (t, n, i) {
      ...
      var s = i(12),
        ...
        f = i(18),
        c = i(10),
        a = c.FileSystemLoader,
        l = c.WebLoader,
        v = c.PrecompiledLoader,
        p = i(20),
        d = i(21),
        m = i(1),
        w = m.Obj,
          ...
          return (
            (i.init = function (t, n) {
              ...
              (n = this.opts = n || {}),
                ...
                (this.loaders = []),
                t
                  ? (this.loaders = u.isArray(t) ? t : [t])
                  : a
                  ? (this.loaders = [new a("views")])
                  : l && (this.loaders = [new l("/views")]),
                "undefined" != typeof window &&
                  window.nunjucksPrecompiled &&
                  this.loaders.unshift(new v(window.nunjucksPrecompiled)),
                this.P(),
                (this.globals = d()),
                (this.filters = {}),
                (this.tests = {}),
                ...
                (this.extensions = {}),
                (this.extensionsList = []),
                u.r(f).forEach(function (t) {
                  var n = t[0],
                    r = t[1];
                  return i.addFilter(n, r);
                }),
                u.r(p).forEach(function (t) {
                  var n = t[0],
                    r = t[1];
            ...
            (i.removeExtension = function (t) {
              ...
              n &&
                ((this.extensionsList = u.without(this.extensionsList, n)),
            ...
            (i.getTemplate = function (t, n, i, r, e) {
              ...
              if (
                (t && t.raw && (t = t.raw),
                u.isFunction(i) && ((e = i), (i = null), (n = n || !1)),
                u.isFunction(n) && ((e = n), (n = !1)),
                t instanceof A)
              )
                f = t;
              else {
                ...
                for (var c = 0; c < this.loaders.length; c++) {
                  var a = this.loaders[c];
                  if ((f = a.cache[this.resolveTemplate(a, i, t)])) break;
                }
              }
              ...
              return (
                u.asyncIter(
                  ...
                  function (i, u) {
                    if (
                      (u || i || r || (i = Error("template not found: " + t)),
                      i)
                    ) {
                    ...
                    var h;
                    u
                      ? ((h = new A(u.src, o, u.path, n)),
                        u.noCache || (u.loader.cache[t] = h))
                      : (h = new A(x, o, "", n)),
                      e ? e(null, h) : (s = h);
                  }
                ),
            ...
            (i.renderString = function (t, n, i, r) {
              return (
                u.isFunction(i) && ((r = i), (i = {})),
                new A(t, this, (i = i || {}).path).render(n, r)
              );
            }),
        ...
        T = (function (t) {
          ...
          return (
            ...
            (i.getSuper = function (t, n, i, r, e, s) {
              var o = u.indexOf(this.blocks[n] || [], i),
                h = this.blocks[n][o + 1];
              if (-1 === o || !h)
        ...
        A = (function (t) {
          ...
          return (
            (i.init = function (t, n, i, r) {
              if (((this.env = n || new j()), u.isObject(t)))
                switch (t.type) {
                  case "code":
              ...
              if (((this.path = i), r))
                try {
                  ...
                  throw u.t(this.path, this.env.opts.dev, t);
                }
            ...
            (i.render = function (t, n, i) {
              ...
              try {
                ...
                var s = u.t(this.path, this.env.opts.dev, t);
                if (i) return O(i, s);
                throw s;
              }
              var o = new T(t || {}, this.blocks, this.env),
                h = n ? n.push(!0) : new k();
              h.topLevel = !0;
              var f = null,
                c = !1;
              return (
                this.rootRenderFunc(this.env, o, h, y, function (t, n) {
                  if (!c || !i || void 0 === n)
                    if (
                      (t && ((t = u.t(r.path, r.env.opts.dev, t)), (c = !0)), i)
                    )
                      e ? O(i, t, n) : i(t, n);
                    else {
                      if (t) throw t;
            ...
            (i.getExported = function (t, n, i) {
              ...
              var r = n ? n.push() : new k();
              r.topLevel = !0;
              var e = new T(t || {}, this.blocks, this.env);
              this.rootRenderFunc(this.env, e, r, y, function (t) {
                t ? i(t, null) : i(null, e.getExported());
              });
            }),
            (i.compile = function () {
              this.compiled || this.B();
            }),
            (i.B = function () {
              var t;
      ...
      t.exports = { Environment: j, Template: A };
    },
    function (t, n, i) {
      "use strict";
      function r(t, n) {
          ...
          return (
            ...
            (h.error = function (t, n, i) {
              ...
              return (
                void 0 !== n && (n += 1),
                void 0 !== i && (i += 1),
                new u.TemplateError(t, n, i)
              );
            }),
            (h.fail = function (t, n, i) {
            ...
            (h.skipSymbol = function (t) {
              return this.skipValue(e.TOKEN_SYMBOL, t);
            }),
            (h.advanceAfterBlockEnd = function (t) {
              var n;
              return (
                t ||
                  ((n = this.peekToken()) ||
                    this.fail("unexpected end of file"),
                  n.type !== e.TOKEN_SYMBOL &&
                    this.fail(
                      "advanceAfterBlockEnd: expected symbol token or explicit name to be passed"
                    ),
                  (t = this.nextToken().value)),
                (n = this.nextToken()) && n.type === e.TOKEN_BLOCK_END
                  ? "-" === n.value.charAt(0) &&
            ...
            (h.advanceAfterVariableEnd = function () {
              var t = this.nextToken();
              t && t.type === e.TOKEN_VARIABLE_END
            ...
            (h.parseFor = function () {
              ...
              if (
                (this.skipSymbol("for")
                  ? ((t = new s.For(i.lineno, i.colno)), (n = "endfor"))
                  : this.skipSymbol("asyncEach")
                  ? ((t = new s.AsyncEach(i.lineno, i.colno)), (n = "endeach"))
                  : this.skipSymbol("asyncAll")
                  ? ((t = new s.AsyncAll(i.lineno, i.colno)), (n = "endall"))
                  : this.fail(
                ...
                t.name instanceof s.Symbol ||
                  this.fail("parseFor: variable name expected for loop"),
                this.peekToken().type === e.TOKEN_COMMA)
              ) {
                var r = t.name;
                for (
                  t.name = new s.Array(r.lineno, r.colno), t.name.addChild(r);
                  this.skip(e.TOKEN_COMMA);
            ...
            (h.parseCall = function () {
              var t = this.peekToken();
              this.skipSymbol("call") || this.fail("expected call");
              var n = this.parseSignature(!0) || new s.NodeList(),
                i = this.parsePrimary();
              this.advanceAfterBlockEnd(t.value);
              var r = this.parseUntilBlocks("endcall");
              this.advanceAfterBlockEnd();
              var e = new s.Symbol(t.lineno, t.colno, "caller"),
                o = new s.Caller(t.lineno, t.colno, e, n, r),
                u = i.args.children;
              return (
                u[u.length - 1] instanceof s.KeywordArgs ||
                  u.push(new s.KeywordArgs()),
                u[u.length - 1].addChild(new s.Pair(t.lineno, t.colno, e, o)),
                new s.Output(t.lineno, t.colno, [i])
              );
            }),
            (h.parseWithContext = function () {
              var t = this.peekToken(),
                n = null;
              return (
            ...
            (h.parseImport = function () {
              ...
              var i = this.parseExpression(),
                ...
                e = new s.Import(t.lineno, t.colno, n, i, r);
              return this.advanceAfterBlockEnd(t.value), e;
            }),
            (h.parseFrom = function () {
              var t = this.peekToken();
              this.skipSymbol("from") || this.fail("parseFrom: expected from");
              var n = this.parseExpression();
              this.skipSymbol("import") ||
                this.fail("parseFrom: expected import", t.lineno, t.colno);
              for (var i, r = new s.NodeList(); ; ) {
                var o = this.peekToken();
                if (o.type === e.TOKEN_BLOCK_END) {
                  r.children.length ||
                    this.fail(
                ...
                if (
                  ...
                  r.addChild(new s.Pair(u.lineno, u.colno, u, h));
                } else r.addChild(u);
                i = this.parseWithContext();
              }
              return new s.FromImport(t.lineno, t.colno, n, r, i);
            }),
            (h.parseBlock = function () {
              var t = this.peekToken();
              this.skipSymbol("block") ||
                this.fail("parseBlock: expected block", t.lineno, t.colno);
              var n = new s.Block(t.lineno, t.colno);
              (n.name = this.parsePrimary()),
                n.name instanceof s.Symbol ||
                  this.fail(
            ...
            (h.parseIf = function () {
              ...
              this.skipSymbol("elseif")
                ? (t = new s.If(n.lineno, n.colno))
                : this.skipSymbol("ifAsync")
                ? (t = new s.IfAsync(n.lineno, n.colno))
                : this.fail(
            ...
            (h.parseSet = function () {
              ...
              for (
                var n, i = new s.Set(t.lineno, t.colno, []);
                (n = this.parsePrimary()) &&
                (i.targets.push(n), this.skip(e.TOKEN_COMMA));

              );
              return (
                this.skipValue(e.TOKEN_OPERATOR, "=")
                  ? ((i.value = this.parseExpression()),
                    this.advanceAfterBlockEnd(t.value))
                  : this.skip(e.TOKEN_BLOCK_END)
                  ? ((i.body = new s.Capture(
                      t.lineno,
                      t.colno,
            ...
            (h.parseSwitch = function () {
              ...
              do {
                ...
                e.push(new s.Case(r.line, r.col, o, u)), (r = this.peekToken());
              ...
              return new s.Switch(t.lineno, t.colno, n, e, i);
            }),
            (h.parseStatement = function () {
              var t = this.peekToken();
              if (
                (t.type !== e.TOKEN_SYMBOL &&
                  this.fail("tag name expected", t.lineno, t.colno),
                this.breakOnBlocks &&
                  -1 !== u.indexOf(this.breakOnBlocks, t.value))
              )
                return null;
              switch (t.value) {
                case "raw":
                ...
                default:
                  if (this.extensions.length)
                    for (var n = 0; n < this.extensions.length; n++) {
                      ...
                      if (-1 !== u.indexOf(i.tags || [], t.value))
                        return i.parse(this, s, e);
                    }
                  this.fail("unknown block tag: " + t.value, t.lineno, t.colno);
              }
            }),
            (h.parseRaw = function (t) {
              for (
                var n = "end" + (t = t || "raw"),
                  i = RegExp(
                    "([\\s\\S]*?){%\\s*(" + t + "|" + n + ")\\s*(?=%})%}"
                ...
                c === t ? (r += 1) : c === n && (r -= 1),
                  0 === r
                    ? ((e += f), this.tokens.backN(h.length - f.length))
                    : (e += h);
              }
              return new s.Output(u.lineno, u.colno, [
                new s.TemplateData(u.lineno, u.colno, e),
              ]);
            }),
            (h.parsePostfix = function (t) {
              for (var n, i = this.peekToken(); i; ) {
                if (i.type === e.TOKEN_LEFT_PAREN)
                  t = new s.FunCall(
                    i.lineno,
                    i.colno,
                    t,
                ...
                else if (i.type === e.TOKEN_LEFT_BRACKET)
                  (n = this.parseAggregate()).children.length > 1 &&
                    this.fail("invalid index"),
                    (t = new s.LookupVal(i.lineno, i.colno, t, n.children[0]));
                else {
                  if (i.type !== e.TOKEN_OPERATOR || "." !== i.value) break;
                  this.nextToken();
                  var r = this.nextToken();
                  r.type !== e.TOKEN_SYMBOL &&
                    this.fail(
                      "expected name as lookup value, got " + r.value,
                      r.lineno,
                      r.colno
                    ),
                    (n = new s.Literal(r.lineno, r.colno, r.value)),
                    (t = new s.LookupVal(i.lineno, i.colno, t, n));
                }
                i = this.peekToken();
              }
              return t;
            }),
            (h.parseExpression = function () {
              return this.parseInlineIf();
            }),
            (h.parseInlineIf = function () {
              var t = this.parseOr();
              if (this.skipSymbol("if")) {
                var n = this.parseOr(),
                  i = t;
                ((t = new s.InlineIf(t.lineno, t.colno)).body = i),
                  (t.cond = n),
                  this.skipSymbol("else")
            ...
            (h.parseOr = function () {
              for (var t = this.parseAnd(); this.skipSymbol("or"); ) {
                var n = this.parseAnd();
                t = new s.Or(t.lineno, t.colno, t, n);
              }
              return t;
            }),
            (h.parseAnd = function () {
              for (var t = this.parseNot(); this.skipSymbol("and"); ) {
                var n = this.parseNot();
                t = new s.And(t.lineno, t.colno, t, n);
              }
              return t;
            }),
            (h.parseNot = function () {
              ...
              return this.skipSymbol("not")
                ? new s.Not(t.lineno, t.colno, this.parseNot())
                : this.parseIn();
            }),
            (h.parseIn = function () {
              for (var t = this.parseIs(); ; ) {
                var n = this.nextToken();
                if (!n) break;
                var i = n.type === e.TOKEN_SYMBOL && "not" === n.value;
                if ((i || this.pushToken(n), !this.skipSymbol("in"))) {
                  i && this.pushToken(n);
                  break;
                }
                var r = this.parseIs();
                (t = new s.In(t.lineno, t.colno, t, r)),
                  i && (t = new s.Not(t.lineno, t.colno, t));
              }
              return t;
            }),
            (h.parseIs = function () {
              ...
              if (this.skipSymbol("is")) {
                var n = this.skipSymbol("not"),
                  i = this.parseCompare();
                (t = new s.Is(t.lineno, t.colno, t, i)),
                  n && (t = new s.Not(t.lineno, t.colno, t));
              }
              return t;
            }),
            (h.parseCompare = function () {
              for (
                var t = ["==", "===", "!=", "!==", "<", ">", "<=", ">="],
                  n = this.parseConcat(),
                  i = [];
              ...
              return i.length
                ? new s.Compare(i[0].lineno, i[0].colno, n, i)
                : n;
            }),
            (h.parseConcat = function () {
              for (
                var t = this.parseAdd();
                this.skipValue(e.TOKEN_TILDE, "~");

              ) {
                var n = this.parseAdd();
                t = new s.Concat(t.lineno, t.colno, t, n);
              }
              return t;
            }),
            (h.parseAdd = function () {
              for (
                ...
                var n = this.parseSub();
                t = new s.Add(t.lineno, t.colno, t, n);
              }
              return t;
            }),
            (h.parseSub = function () {
              for (
                ...
                var n = this.parseMul();
                t = new s.Sub(t.lineno, t.colno, t, n);
              }
              return t;
            }),
            (h.parseMul = function () {
              for (
                ...
                var n = this.parseDiv();
                t = new s.Mul(t.lineno, t.colno, t, n);
              }
              return t;
            }),
            (h.parseDiv = function () {
              for (
                ...
                t = new s.Div(t.lineno, t.colno, t, n);
              }
              return t;
            }),
            (h.parseFloorDiv = function () {
              for (
                var t = this.parseMod();
                this.skipValue(e.TOKEN_OPERATOR, "//");
                ...
                var n = this.parseMod();
                t = new s.FloorDiv(t.lineno, t.colno, t, n);
              }
              return t;
            }),
            (h.parseMod = function () {
              for (
                ...
                var n = this.parsePow();
                t = new s.Mod(t.lineno, t.colno, t, n);
              }
              return t;
            }),
            (h.parsePow = function () {
              for (
                ...
                t = new s.Pow(t.lineno, t.colno, t, n);
              }
              return t;
            }),
            (h.parseUnary = function (t) {
              var n,
                i = this.peekToken();
              return (
                (n = this.skipValue(e.TOKEN_OPERATOR, "-")
                  ? new s.Neg(i.lineno, i.colno, this.parseUnary(!0))
                  : this.skipValue(e.TOKEN_OPERATOR, "+")
                  ? new s.Pos(i.lineno, i.colno, this.parseUnary(!0))
                  : this.parsePrimary()),
                t || (n = this.parseFilter(n)),
                n
              );
            }),
            (h.parsePrimary = function (t) {
              var n,
                i = this.nextToken(),
                r = null;
              if (
                (i
                  ? i.type === e.TOKEN_STRING
                    ? (n = i.value)
                    : i.type === e.TOKEN_INT
                    ? (n = parseInt(i.value, 10))
                    : i.type === e.TOKEN_FLOAT
                    ? (n = parseFloat(i.value))
                    : i.type === e.TOKEN_BOOLEAN
                    ? "true" === i.value
                      ? (n = !0)
                      : "false" === i.value
                      ? (n = !1)
                    ...
                    : i.type === e.TOKEN_NONE
                    ? (n = null)
                    : i.type === e.TOKEN_REGEX &&
                      (n = RegExp(i.value.body, i.value.flags))
                  : this.fail("expected expression, got end of file"),
                void 0 !== n
                  ? (r = new s.Literal(i.lineno, i.colno, n))
                  : i.type === e.TOKEN_SYMBOL
                  ? (r = new s.Symbol(i.lineno, i.colno, i.value))
                  : (this.pushToken(i), (r = this.parseAggregate())),
                t || (r = this.parsePostfix(r)),
                r)
              )
                return r;
              throw this.error(
            ...
            (h.parseFilterName = function () {
              for (
                var t = this.expect(e.TOKEN_SYMBOL), n = t.value;
                this.skipValue(e.TOKEN_OPERATOR, ".");

              )
                n += "." + this.expect(e.TOKEN_SYMBOL).value;
              return new s.Symbol(t.lineno, t.colno, n);
            }),
            (h.parseFilterArgs = function (t) {
              return this.peekToken().type === e.TOKEN_LEFT_PAREN
                ? this.parsePostfix(t).args.children
                : [];
            }),
            (h.parseFilter = function (t) {
              for (; this.skip(e.TOKEN_PIPE); ) {
            ...
            (h.parseFilterStatement = function () {
              var t = this.peekToken();
              ...
              var e = new s.Filter(
                ...
                n.colno,
                n,
                new s.NodeList(n.lineno, n.colno, [r].concat(i))
              );
              return new s.Output(n.lineno, n.colno, [e]);
            }),
            (h.parseAggregate = function () {
              var t,
                n = this.nextToken();
              switch (n.type) {
                case e.TOKEN_LEFT_PAREN:
                  t = new s.Group(n.lineno, n.colno);
                  break;
                case e.TOKEN_LEFT_BRACKET:
                  t = new s.Array(n.lineno, n.colno);
                  break;
                case e.TOKEN_LEFT_CURLY:
                  t = new s.Dict(n.lineno, n.colno);
                  break;
                default:
                  return null;
              }
              for (;;) {
                ...
                if (
                  i === e.TOKEN_RIGHT_PAREN ||
                  i === e.TOKEN_RIGHT_BRACKET ||
                  i === e.TOKEN_RIGHT_CURLY
                ) {
                  this.nextToken();
                  break;
                }
                if (
                  ...
                  var o = this.parseExpression();
                  t.addChild(new s.Pair(r.lineno, r.colno, r, o));
                } else {
            ...
            (h.parseSignature = function (t, n) {
              var i = this.peekToken();
              if (!n && i.type !== e.TOKEN_LEFT_PAREN) {
                if (t) return null;
                this.fail("expected arguments", i.lineno, i.colno);
              }
              i.type === e.TOKEN_LEFT_PAREN && (i = this.nextToken());
              for (
                var r = new s.NodeList(i.lineno, i.colno),
                  o = new s.KeywordArgs(i.lineno, i.colno),
                  u = !1;
                ;

              ) {
                if (
                  ((i = this.peekToken()), !n && i.type === e.TOKEN_RIGHT_PAREN)
                ) {
                  this.nextToken();
                  break;
                }
                if (n && i.type === e.TOKEN_BLOCK_END) break;
                if (u && !this.skip(e.TOKEN_COMMA))
                  this.fail(
                  ...
                  this.skipValue(e.TOKEN_OPERATOR, "=")
                    ? o.addChild(
                        new s.Pair(h.lineno, h.colno, h, this.parseExpression())
                      )
                    : r.addChild(h);
                }
                u = !0;
              }
              return o.children.length && r.addChild(o), r;
            }),
            (h.parseUntilBlocks = function () {
              for (
            ...
            (h.parseNodes = function () {
              for (var t, n = []; (t = this.nextToken()); )
                if (t.type === e.TOKEN_DATA) {
                  var i = t.value,
                    r = this.peekToken(),
                    o = r && r.value;
                  this.dropLeadingWhitespace &&
                    ...
                    (this.dropLeadingWhitespace = !1)),
                    r &&
                      ((r.type === e.TOKEN_BLOCK_START &&
                        "-" === o.charAt(o.length - 1)) ||
                        (r.type === e.TOKEN_VARIABLE_START &&
                          "-" ===
                            o.charAt(this.tokens.tags.VARIABLE_START.length)) ||
                        (r.type === e.TOKEN_COMMENT &&
                          "-" ===
                            o.charAt(this.tokens.tags.COMMENT_START.length))) &&
                      (i = i.replace(/\s*$/, "")),
                    n.push(
                      new s.Output(t.lineno, t.colno, [
                        new s.TemplateData(t.lineno, t.colno, i),
                      ])
                    );
                } else if (t.type === e.TOKEN_BLOCK_START) {
                  this.dropLeadingWhitespace = !1;
                  var u = this.parseStatement();
                  if (!u) break;
                  n.push(u);
                } else if (t.type === e.TOKEN_VARIABLE_START) {
                  var h = this.parseExpression();
                  (this.dropLeadingWhitespace = !1),
                    this.advanceAfterVariableEnd(),
                    n.push(new s.Output(t.lineno, t.colno, [h]));
                } else
                  t.type === e.TOKEN_COMMENT
                    ? (this.dropLeadingWhitespace =
                        "-" ===
                        t.value.charAt(
                          t.value.length -
            ...
            (h.parse = function () {
              return new s.NodeList(0, 0, this.parseNodes());
            }),
            (h.parseAsRoot = function () {
              return new s.Root(0, 0, this.parseNodes());
            }),
            o
          );
        })(o);
      t.exports = {
        parse: function (t, n, i) {
          var r = new h(e.lex(t, i));
          return void 0 !== n && (r.extensions = n), r.parseAsRoot();
        },
        Parser: h,
      };
    },
        ...
        return (
          (n.nextToken = function () {
            ...
            if (this.in_code) {
              ...
              if ('"' === e || "'" === e) return c("string", this.U(e), n, i);
              if ((t = this.$(" \n\t\r "))) return c("whitespace", t, n, i);
              if (
              ...
              if (
                ...
                return (this.in_code = !1), c("variable-end", t, n, i);
              if ("r" === e && "/" === this.str.charAt(this.index + 1)) {
                ...
                return c("regex", { body: s, flags: u }, n, i);
              }
              if (-1 !== "()[]{}%*-+~/#,:|.<>=!".indexOf(e)) {
                this.forward();
                var h,
                ...
                switch (
                  (-1 !== r.indexOf(f, a) &&
                    (this.forward(),
                    (e = a),
                    -1 !== r.indexOf(f, a + this.current()) &&
                      ((e = a + this.current()), this.forward())),
                  e)
                ) {
                  case "(":
                    h = "left-paren";
              ...
              if (
                ...
                return "." === this.current()
                  ? (this.forward(),
                    c("float", t + "." + this.$("0123456789"), n, i))
                  : c("int", t, n, i);
              if (t.match(/^(true|false)$/)) return c("boolean", t, n, i);
              if ("none" === t) return c("none", t, n, i);
              if ("null" === t) return c("none", t, n, i);
              if (t) return c("symbol", t, n, i);
            ...
            if (
              ...
              return (this.in_code = !0), c("block-start", t, n, i);
            if (
              (t = this.G(this.tags.VARIABLE_START + "-")) ||
              (t = this.G(this.tags.VARIABLE_START))
            )
              return (this.in_code = !0), c("variable-start", t, n, i);
            t = "";
            var p = !1;
            for (
    ...
    function (t, n, i) {
      ...
      t.exports = { WebLoader: o, PrecompiledLoader: s };
    },
    function (t, n, i) {
      "use strict";
      var r,
    ...
    function (t, n, i) {
        ...
        (t.exports.once = function (t, n) {
          return new Promise(function (i, r) {
            ...
            m(t, n, s, { once: !0 }),
              "error" !== n &&
                (function (t, n, i) {
                  "function" == typeof t.on && m(t, "error", n, i);
                })(t, e, { once: !0 });
          });
        }),
        (u.EventEmitter = u),
        (u.prototype.z = void 0),
        (u.prototype.Y = 0),
        (u.prototype.q = void 0);
      var h = 10;
      function f(t) {
        if ("function" != typeof t)
          throw new TypeError(
      ...
      function c(t) {
        return void 0 === t.q ? u.defaultMaxListeners : t.q;
      }
      function a(t, n, i, r) {
        var e, s, o;
        if (
          (f(i),
          void 0 === (s = t.z)
            ? ((s = t.z = Object.create(null)), (t.Y = 0))
            : (void 0 !== s.newListener &&
                (t.emit("newListener", n, i.listener ? i.listener : i),
                (s = t.z)),
              (o = s[n])),
          void 0 === o)
        )
      ...
      function l(t, n, i) {
        var r = { fired: !1, wrapFn: void 0, target: t, type: n, listener: i },
          e = function () {
            if (!this.fired)
              return (
        ...
        return (e.listener = i), (r.wrapFn = e), e;
      }
      function v(t, n, i) {
        var r = t.z;
        if (void 0 === r) return [];
        ...
        return void 0 === e
          ...
          : i
          ? (function (t) {
              for (var n = Array(t.length), i = 0; i < n.length; ++i)
                n[i] = t[i].listener || t[i];
              return n;
            })(e)
          : d(e, e.length);
      }
      ...
      function d(t, n) {
        for (var i = Array(n), r = 0; r < n; ++r) i[r] = t[r];
        return i;
      }
      function m(t, n, i, r) {
        if ("function" == typeof t.on) r.once ? t.once(n, i) : t.on(n, i);
        else {
          ...
          t.addEventListener(n, function e(s) {
            r.once && t.removeEventListener(n, e), i(s);
          });
        }
      }
      Object.defineProperty(u, "defaultMaxListeners", {
        ...
        (u.init = function () {
          (void 0 !== this.z && this.z !== Object.getPrototypeOf(this).z) ||
            ((this.z = Object.create(null)), (this.Y = 0)),
        ...
        (u.prototype.emit = function (t) {
          ...
          var r = "error" === t,
            e = this.z;
          if (void 0 !== e) r = r && void 0 === e.error;
          else if (!r) return !1;
          if (r) {
            var o;
          ...
          if ("function" == typeof h) s(h, this, n);
          else {
            var f = h.length,
              c = d(h, f);
            for (i = 0; i < f; ++i) s(c[i], this, n);
          }
          return !0;
        }),
        ...
        (u.prototype.once = function (t, n) {
          return f(n), this.on(t, l(this, t, n)), this;
        }),
        (u.prototype.prependOnceListener = function (t, n) {
          return f(n), this.prependListener(t, l(this, t, n)), this;
        }),
        (u.prototype.removeListener = function (t, n) {
          var i, r, e, s, o;
          if ((f(n), void 0 === (r = this.z))) return this;
          ...
          if (i === n || i.listener === n)
            ...
            0 === e
              ...
              void 0 !== r.removeListener &&
                this.emit("removeListener", t, o || n);
          }
          return this;
        }),
        ...
        (u.prototype.removeAllListeners = function (t) {
          var n, i, r;
          if (void 0 === (i = this.z)) return this;
          ...
          if (0 === arguments.length) {
            ...
            for (r = 0; r < s.length; ++r)
              "removeListener" !== (e = s[r]) && this.removeAllListeners(e);
            return (
          ...
          if ("function" == typeof (n = i[t])) this.removeListener(t, n);
          else if (void 0 !== n)
    ...
    function (t, n, i) {
            ...
            return (
              o.sort(function (t, o) {
                var h = e ? u(t) : t,
                  f = e ? u(o) : o;
                if (
                  s.env.opts.throwOnUndefined &&
                  e &&
                  (void 0 === h || void 0 === f)
                )
                  throw new TypeError(
                    'sort: attribute "' + e + '" resolved to undefined'
                  );
                return (
                  !i &&
                    r.isString(h) &&
                    r.isString(f) &&
                    ((h = h.toLowerCase()), (f = f.toLowerCase())),
                  h < f ? (n ? 1 : -1) : h > f ? (n ? -1 : 1) : 0
                );
              }),
              o
            );
      ...
      var m = e.makeMacro(["value", "default", "base"], [], function (t, n, i) {
        void 0 === i && (i = 10);
        var r = parseInt(t, i);
        return o(r) ? n : r;
      });
      (n.int = m), (n.d = n.default), (n.e = n.escape);
    },
    function (t, n, i) {
      "use strict";
      function r(t, n) {
    ...
    function (t, n, i) {
      ...
      t.exports = {
        precompile: function (t, n) {
          var i = (n = n || {}).env || new u([]),
            s = n.wrapper || h;
          if (n.isString) return c(t, n);
          var o = r.existsSync(t) && r.statSync(t),
            l = [],
            v = [];
          if (o.isFile()) l.push(a(r.readFileSync(t, "utf-8"), n.name || t, i));
            ...
            for (var p = 0; p < v.length; p++) {
              ...
              try {
                l.push(a(r.readFileSync(v[p], "utf-8"), d, i));
              } catch (t) {
                if (!n.force) throw t;
                console.error(t);
              }
      ...
      t.exports = function () {
        ...
        if (
          ...
          (e.prototype.assertType = function (n) {
            n instanceof a || t.apply(this, arguments);
          }),
            ...
            (s.prototype.parseAggregate = function () {
              ...
              try {
                ...
                this.nextToken();
                for (
                  var f = new a(h.lineno, h.colno), l = !1, v = 0;
